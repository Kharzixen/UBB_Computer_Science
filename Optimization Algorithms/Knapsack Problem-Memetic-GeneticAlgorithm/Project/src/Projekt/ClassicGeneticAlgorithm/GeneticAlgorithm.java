...
public class GeneticAlgorithm {
    ...
    public GeneticAlgorithm(int populationSize, int length, double probMutation, ArrayList<Item> items, double sackSize) {
        double probOfTrue1;
    ...
    public ArrayList<Individual> GetInitialPopulation() {
        ...
        while (i < populationSize) {
            ...
            if (Fitness(individual) != 0 && !IsInPopulation(population, individual)) {
